  ...
  return (
    <div className="relative space-y-3 dark">
      ...
      <button
        ...
        className="w-full flex justify-between items-center px-4 py-3 rounded-md  border border-white/10 bg-white/8  transition text-left text-zinc-200 hover:bg-white/12"
      >
